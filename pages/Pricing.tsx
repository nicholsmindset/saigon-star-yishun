      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="space-y-16">
            ...
            {SERVICES.map((service) => (
              <div key={service.id} className="flex justify-between items-end border-b border-brand-accent/30 pb-4 group">
                <div className="flex-grow">
                  ...
                  <p className="text-xs text-brand-dark/70 italic">{service.duration}</p>
                </div>
          ...
          <div className="bg-brand-nude p-12 text-center border-2 border-dashed border-brand-gold/30">
            ...
            <p className="text-sm text-brand-dark/80 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 shadow-sm">
                ...
                <p className="text-2xl font-serif text-brand-gold mb-4">$118 <span className="text-sm font-sans text-brand-dark/60">/ Value $135</span></p>
                <p className="text-xs text-brand-dark/80 leading-relaxed">Includes Signature Gel Manicure & Classic Pedicure.</p>
              </div>
              <div className="bg-white p-6 shadow-sm border border-brand-gold/20">
                ...
                <p className="text-2xl font-serif text-brand-gold mb-4">$280 <span className="text-sm font-sans text-brand-dark/60">/ Value $330</span></p>
                <p className="text-xs text-brand-dark/80 leading-relaxed">The ultimate head-to-toe pampering for your big day.</p>
              </div>
            </div>
            <Link to="/contact" className="inline-block mt-8 text-xs uppercase tracking-widest font-bold border-b border-brand-gold pb-1">
