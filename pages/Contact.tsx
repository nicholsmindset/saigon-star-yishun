    ...
    <div className="bg-brand-nude pt-32 pb-32 lg:pb-24 min-h-screen">
      <div className="container mx-auto px-6">
        <header className="text-center mb-20">
          ...
          <h1 className="text-5xl font-serif text-brand-dark mb-8">Visit Our Studio</h1>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          <div className="space-y-12">
            ...
            <div>
              <h3 className="text-xs uppercase tracking-widest font-bold text-brand-gold mb-4">Contact</h3>
          ...
          {/* Form Side */}
          <div className="bg-white p-12 shadow-2xl border border-brand-accent/20 rounded-sm">
            <h3 className="text-2xl font-serif text-brand-dark mb-8">Quick Enquiry</h3>
