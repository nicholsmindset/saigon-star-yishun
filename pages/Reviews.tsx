    ...
    <div className="bg-brand-nude pt-32 pb-32 lg:pb-24 min-h-screen">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <div className="bg-white p-12 shadow-2xl border border-brand-accent/20">
            ...
            {/* Google Reviews Link */}
            <div className="mt-8 pt-8 border-t border-brand-accent/20 text-center">
              <a
                href="https://www.google.com/search?q=saigon+star+yishun"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-brand-dark text-white px-8 py-4 text-xs uppercase tracking-widest font-bold hover:bg-brand-gold transition-colors"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {GOOGLE_REVIEWS.map((review) => (
            <div
              key={review.id}
              className="bg-white p-8 shadow-lg border border-brand-accent/10 hover-lift"
            >
              {/* Stars */}
        ...
        {/* CTA Section */}
        <div className="bg-white p-12 shadow-2xl text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/#/booking"
              className="bg-brand-gold text-white px-10 py-4 text-xs uppercase tracking-widest font-bold hover:bg-brand-dark transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-500 text-white px-10 py-4 text-xs uppercase tracking-widest font-bold hover:bg-green-600 transition-colors"
            >
              WhatsApp Us
            </a>
          </div>
